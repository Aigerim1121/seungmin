...
import { getProducts } from "../redux/umbrellaApi/umbrellaApi";
...
function Umbrella() {
  ...
  const filteredProducts = products.filter((item) => {
    ...
    if (filterType === "max") return price >= 2500;
    if (filterType === "min") return price < 2500;
