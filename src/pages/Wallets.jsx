...
import { getProducts } from "../redux/walletApi/walletApi";
...
function Wallets() {
  ...
  const filteredProducts = products.filter((item) => {
    ...
    if (filterType === "max") return price >= 2000;
    if (filterType === "min") return price < 2000;
